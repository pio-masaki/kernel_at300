...
static const struct tegra_emc_table ast_emc_tables_k4b2g08460[] =
{
	...
	},
	{
		...
		667000,     /* SDRAM frequency */
		{
			...
			0xa0f11a1a, /* EMC_AUTO_CAL_CONFIG */
			0x00000000, /* EMC_CTT */
			0x00000000, /* EMC_CTT_DURATION */
...
/*Avalon Samsung 1G k4b2g0846D*/
/*for re-layout*/
static const struct tegra_emc_table avalon_emc_tables_k4b2g0846d_2[] =
{
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
...
/*Avalon Hynix 1G H5TC2G83CFR-H9A for re-layout board*/
static const struct tegra_emc_table avalon_emc_tables_h5tc2g83cfr_3[] =
{
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
...
static void avalon_init_emc(void) {
    ...
    case 1:
        ...
        break;
    case 2:	                    /* for re-layout board */
        pr_info("%s: ram:Samsung K4B2G0846D-HYH9 667Mhz\n", __func__);
        emc_tables = avalon_emc_tables_k4b2g0846d_2;
        emc_tables_size = ARRAY_SIZE(avalon_emc_tables_k4b2g0846d_2);
        break;
    case 3:                     /* for re-layout board */
        pr_info("%s: ram:Hynix H5TC2G83CFR-H9A 667Mhz\n", __func__);
        emc_tables = avalon_emc_tables_h5tc2g83cfr_3;
        emc_tables_size = ARRAY_SIZE(avalon_emc_tables_h5tc2g83cfr_3);
        break;
    }
