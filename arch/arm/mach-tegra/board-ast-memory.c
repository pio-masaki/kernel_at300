...
static const struct tegra_emc_table ast_emc_tables_h5tc2g[] = {
	{
		0x30,		/* Rev 3.0 */
...
static const struct tegra_emc_table ast_emc_tables_h5tc2g_a2[] = {
	{
		0x32,       /* Rev 3.2 */
...
static const struct tegra_emc_table ast_emc_tables_h5tc2g_a2_2GB1R[] = {
	{
		0x32,       /* Rev 3.2 */
		51000,      /* SDRAM frequency */
		{
...
static const struct tegra_emc_table ast_emc_tables_k4b4g0846b_hyk0[] = {
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra_emc_table ast_emc_tables_k4p8g304eb[] = {
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra_emc_table ast_emc_tables_edb8132b2ma[] = {
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
/*Samsung 1G k4b2g08460*/
static const struct tegra_emc_table ast_emc_tables_k4b2g08460[] =
{
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
	...
	},
	{
		...
		667000,     /* SDRAM frequency */
		{
			...
			0x00000000, /* EMC_DLI_TRIM_TXDQS6 */
			0x00000000, /* EMC_DLI_TRIM_TXDQS7 */
			0x0000800c, /* EMC_DLL_XFORM_DQ0 */
			0x0000800c, /* EMC_DLL_XFORM_DQ1 */
			0x0000800c, /* EMC_DLL_XFORM_DQ2 */
			0x0000800c, /* EMC_DLL_XFORM_DQ3 */
			0x000002a0, /* EMC_XM2CMDPADCTRL */
			0x0800013d, /* EMC_XM2DQSPADCTRL2 */
			0x22220000, /* EMC_XM2DQPADCTRL2 */
			0x77fff884, /* EMC_XM2CLKPADCTRL */
...
/*Avalon Samsung 1G k4b2g0846D*/
static const struct tegra_emc_table avalon_emc_tables_k4b2g0846d[] =
{
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
	...
	},
	{
		...
		667000,     /* SDRAM frequency */
		{
			...
			0x77fff884, /* EMC_XM2CLKPADCTRL */
			0x01f1f501, /* EMC_XM2COMPPADCTRL */
			0x07077304, /* EMC_XM2VTTGENPADCTRL */
			0x54000000, /* EMC_XM2VTTGENPADCTRL2 */
			0x080001e8, /* EMC_XM2QUSEPADCTRL */
			0x08000021, /* EMC_XM2DQSPADCTRL3 */
			0x00000802, /* EMC_CTT_TERM_CTRL */
...
/*Avalon Hynix 1G H5TC2G83CFR-H9A*/
static const struct tegra_emc_table avalon_emc_tables_h5tc2g83cfr[] =
{
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
...
/*Sphinx Samsung 1G K4P8G304EB*/
static const struct tegra_emc_table sphinx_emc_tables_k4p8g304eb[] =
{
    {
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
...
/*Sphinx Elpida 1G EDB8132B3MA*/
static const struct tegra_emc_table sphinx_emc_tables_edb8132b3ma[] =
{
    {
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
...
static void avalon_init_emc(void) {
    u32 reg;
    int ram_id;
    ...
    switch (ram_id) {
        ...
        case 0:
            ...
            emc_tables = avalon_emc_tables_k4b2g0846d;
            emc_tables_size = ARRAY_SIZE(avalon_emc_tables_k4b2g0846d);
            break;

        case 1:
            pr_info("%s: ram:Hynix H5TC2G83CFR-H9A 667Mhz\n", __func__);
            emc_tables = avalon_emc_tables_h5tc2g83cfr;
            emc_tables_size = ARRAY_SIZE(avalon_emc_tables_h5tc2g83cfr);
            break;
    }
...
static void sphinx_init_emc(void) {
    u32 reg;
    int ram_id;
    void __iomem *apb_misc = IO_ADDRESS(TEGRA_APB_MISC_BASE);
    const struct tegra_emc_table *emc_tables;
    ...
    switch (ram_id) {
        default:
        case 0:
            pr_info("%s: ram:Samsung K4P8G304EB-FGC2 533Mhz\n", __func__);
            emc_tables = sphinx_emc_tables_k4p8g304eb;
            emc_tables_size = ARRAY_SIZE(sphinx_emc_tables_k4p8g304eb);
            break;

        case 1:
            pr_info("%s: ram:Elpida EDB8132B3MA-1D-F 533Mhz\n", __func__);
            emc_tables = sphinx_emc_tables_edb8132b3ma;
            emc_tables_size = ARRAY_SIZE(sphinx_emc_tables_edb8132b3ma);
            break;
    }
...
int ast_emc_init(void)
{
    if (machine_is_avalon()) {
        /* emc: please add avalon-specific here */
        avalon_init_emc();
    } else if (machine_is_sphinx()) {
        /* emc: please add sphinx-specific here */
        sphinx_init_emc();
    } else if (machine_is_titan()) {
        /* emc: please add titan-specific here */
		tegra_init_emc(ast_emc_tables_k4b2g08460,
			ARRAY_SIZE(ast_emc_tables_k4b2g08460));
    }
