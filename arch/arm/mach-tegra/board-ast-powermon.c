/*
 * arch/arm/mach-tegra/board-ast-powermon.c
 *
...
static struct i2c_board_info ast_i2c0_ina219_board_info[] = {
	[INA_I2C_ADDR_40] = {
...
int __init ast_pmon_init(void)
{
	...
	if (bi.fab == BOARD_FAB_A04) {
		ast_i2c0_ina219_board_info[INA_I2C_ADDR_44].platform_data =
			&power_mon_info[UNUSED_RAIL];
		ast_i2c0_ina219_board_info[INA_I2C_ADDR_4A].platform_data =
			&power_mon_info[VDD_CORE_IN];
	}

	i2c_register_board_info(0, ast_i2c0_ina219_board_info,
		ARRAY_SIZE(ast_i2c0_ina219_board_info));
	return 0;
}
