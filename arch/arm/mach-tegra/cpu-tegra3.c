...
static int tegra3_auto_hotplug_reboot_notify(struct notifier_block *nb,
...
static struct notifier_block tegra3_auto_hotplug_reboot_nb = {
    .notifier_call = tegra3_auto_hotplug_reboot_notify,
};
...
int tegra_auto_hotplug_init(struct mutex *cpu_lock)
{
    ...
    register_reboot_notifier(&tegra3_auto_hotplug_reboot_nb);
