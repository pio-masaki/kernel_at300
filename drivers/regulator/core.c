...
EXPORT_SYMBOL_GPL(regulator_use_count_dump);
...
static int regulator_use_count_show(struct seq_file *s, void *unused)
{
    struct regulator_dev *rdev;

    seq_printf(s, "Regulators Use Count\n");
    seq_printf(s, "-------------------------\n");
...
static int regulator_use_count_open(struct inode *inode, struct file *file)
{
    return single_open(file, regulator_use_count_show, inode->i_private);
}

static const struct file_operations regulator_use_count_fops = {
    .open       = regulator_use_count_open,
    .read       = seq_read,
    .llseek     = seq_lseek,
...
static int __init regulator_init_debugfs(void)
{
    ...
    debugfs_create_file("regulator_use_count", S_IRUGO, NULL, NULL,
                        &regulator_use_count_fops);
